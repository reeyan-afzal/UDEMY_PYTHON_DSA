...
class DoublyLinkedList:
    ...
    def insert(self, index, value):
        ...
        after = before.nextptr

        new_node.prevprt = before
        new_node.nextptr = after
        before.nextptr = new_node
        after.prevprt = new_node
    ...
    def remove(self, index):
        ...
        temp = self.get(index)
        temp.nextptr.prevprt = temp.prevprt
        temp.prevprt.nextptr = temp.nextptr
        temp.prevprt = None
        temp.nextptr = None
